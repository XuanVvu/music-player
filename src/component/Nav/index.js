        ...
        <div className="navContainer">
            ...
            <div>
                <svg
                    ...
                    height="24"
                    width="24"
                    class="Svg-ytk21e-0 jAKAlG search-icon"
                    aria-hidden="true"
                    viewBox="0 0 24 24"
                >
            ...
            <div class="cd">
                <div class="cd-thumb" style={{ backgroundImage: `url('${song.links.images[0].url}')` }}></div>
            </div>
            <div className="authorName-container">
                <h4 className="author-name">{song.author}</h4>
            </div>
        </div>
    );
}
